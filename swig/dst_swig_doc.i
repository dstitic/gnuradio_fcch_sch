...
%feature("docstring") dst_fcch "<+description+>"

%feature("docstring") dst_fcch::dst_fcch "

Params: (rho, G, D, taps)"

%feature("docstring") dst_fcch::rho "

Params: (NONE)"

%feature("docstring") dst_fcch::set_rho "

Params: (rho)"

%feature("docstring") dst_fcch::G "

Params: (NONE)"

%feature("docstring") dst_fcch::set_G "

Params: (G)"

%feature("docstring") dst_fcch::D "

Params: (NONE)"

%feature("docstring") dst_fcch::set_D "

Params: (D)"

%feature("docstring") dst_fcch::taps "

Params: (NONE)"

%feature("docstring") dst_fcch::set_taps "
...
%feature("docstring") dst_fcch::general_work "

Params: (noutput_items, ninput_items, input_items, output_items)"

%feature("docstring") dst_make_fcch "<+description+>

Params: (rho, G, D, taps)"

%feature("docstring") dst_fcchsync "Calculates the Freqency offset of a GSM system by searching the FCCH <+description+>"

%feature("docstring") dst_fcchsync::dst_fcchsync "

Params: (rho, G, D, taps, osr, fsamp)"

%feature("docstring") dst_fcchsync::rho "

Params: (NONE)"

%feature("docstring") dst_fcchsync::set_osr "

Params: (osr)"

%feature("docstring") dst_fcchsync::set_rho "

Params: (rho)"

%feature("docstring") dst_fcchsync::G "

Params: (NONE)"

%feature("docstring") dst_fcchsync::set_G "

Params: (G)"

%feature("docstring") dst_fcchsync::D "

Params: (NONE)"

%feature("docstring") dst_fcchsync::fsamp "

Params: (NONE)"

%feature("docstring") dst_fcchsync::set_D "

Params: (D)"

%feature("docstring") dst_fcchsync::taps "

Params: (NONE)"

%feature("docstring") dst_fcchsync::set_taps "

Params: (taps)"

%feature("docstring") dst_fcchsync::calculate_fcch_firale "
...
%feature("docstring") dst_fcchsync::work "

Params: (noutput_items, input_items, output_items)"

%feature("docstring") dst_make_fcchsync "Calculates the Freqency offset of a GSM system by searching the FCCH <+description+>

Params: (rho, G, D, taps, osr, fsamp)"

%feature("docstring") dst_sch "<+description+>"

%feature("docstring") dst_sch::dst_sch "
...
%feature("docstring") dst_sch::set_osr "

Params: (osr)"

%feature("docstring") dst_sch::work "

Params: (noutput_items, input_items, output_items)"

%feature("docstring") dst_make_sch "<+description+>
